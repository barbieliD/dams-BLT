...
true ? ButtonBase.propTypes = {
   ...
   * @ignore
   */
  formAction: import_prop_types11.default.oneOfType([import_prop_types11.default.func, import_prop_types11.default.string]),
  /**
   * @ignore
   */
...
var CircularProgress = React14.forwardRef(function CircularProgress2(inProps, ref) {
  ...
  return (0, import_jsx_runtime4.jsx)(CircularProgressRoot, {
    ...
    ...rootProps,
    ...other,
    children: (0, import_jsx_runtime4.jsxs)(CircularProgressSVG, {
      className: classes.svg,
      ownerState,
      viewBox: `${SIZE / 2} ${SIZE / 2} ${SIZE} ${SIZE}`,
      children: [enableTrackSlot ? (0, import_jsx_runtime4.jsx)(CircularProgressTrack, {
        ...
        "aria-hidden": "true"
      }) : null, (0, import_jsx_runtime4.jsx)(CircularProgressCircle, {
...
true ? CircularProgress.propTypes = {
   ...
   * @default false
   */
  enableTrackSlot: import_prop_types12.default.bool,
  /**
...
var Typography = React16.forwardRef(function Typography2(inProps, ref) {
  const {
    color,
    ...themeProps
  } = useDefaultProps({
...
true ? Typography.propTypes = {
   ...
   * [palette customization guide](https://mui.com/material-ui/customization/palette/#custom-colors).
   */
  color: import_prop_types14.default.oneOfType([import_prop_types14.default.oneOf(["primary", "secondary", "success", "error", "info", "warning", "textPrimary", "textSecondary", "textDisabled"]), import_prop_types14.default.string]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
...
var Portal = React18.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React18.isValidElement(children2) ? getReactElementRef(children2) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
// node_modules/@mui/material/esm/utils/isLayoutSupported.js
...
var PopperTooltip = React19.forwardRef(function PopperTooltip2(props, forwardedRef) {
  const {
    anchorEl,
    children: children2,
    direction,
  ...
  const popperRef = React19.useRef(null);
  const handlePopperRef = useForkRef(popperRef, popperRefProp);
  const handlePopperRefRef = React19.useRef(handlePopperRef);
  useEnhancedEffect_default(() => {
    handlePopperRefRef.current = handlePopperRef;
  }, [handlePopperRef]);
  React19.useImperativeHandle(popperRefProp, () => popperRef.current, []);
  const rtlPlacement = flipPlacement(initialPlacement, direction);
  const [placement, setPlacement] = React19.useState(rtlPlacement);
  const [resolvedAnchorElement, setResolvedAnchorElement] = React19.useState(resolveAnchorEl(anchorEl));
  React19.useEffect(() => {
...
var Popper = React19.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children: children2,
  ...
  return (0, import_jsx_runtime7.jsx)(Portal_default, {
    disablePortal,
    container,
    children: (0, import_jsx_runtime7.jsx)(PopperTooltip, {
      anchorEl,
      direction,
      disablePortal,
      modifiers,
...
var Popper3 = React20.forwardRef(function Popper4(inProps, ref) {
  const isRtl = useRtl();
  const props = useDefaultProps({
    props: inProps,
    name: "MuiPopper"
  ...
  return (0, import_jsx_runtime8.jsx)(PopperRoot, {
    as: component,
...
var Chip = React21.forwardRef(function Chip2(inProps, ref) {
  ...
  return (0, import_jsx_runtime10.jsxs)(RootSlot, {
    as: component,
    ...rootProps,
    children: [avatar || icon, (0, import_jsx_runtime10.jsx)(LabelSlot, {
      ...labelProps,
      children: label
    }), deleteIcon]
  });
...
true ? Chip.propTypes = {
   ...
   */
  avatar: import_prop_types18.default.element,
  /**
   ...
   */
  clickable: import_prop_types18.default.bool,
  /**
   * The color of the component.
   * It supports both default and custom theme colors, which can be added as shown in the
   * [palette customization guide](https://mui.com/material-ui/customization/palette/#custom-colors).
   ...
   */
  deleteIcon: import_prop_types18.default.element,
  /**
   * If `true`, the component is disabled.
   * @default false
   */
   ...
   * @default false
   */
  skipFocusWhenDisabled: import_prop_types18.default.bool,
  /**
   ...
   * @default 'filled'
   */
  variant: import_prop_types18.default.oneOfType([import_prop_types18.default.oneOf(["filled", "outlined"]), import_prop_types18.default.string])
} : void 0;
...
var TextareaAutosize = React22.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  const heightRef = React22.useRef(null);
  const hiddenTextareaRef = React22.useRef(null);
  const calculateTextareaStyles = React22.useCallback(() => {
  ...
  const syncHeight = React22.useCallback(() => {
    const textarea = textareaRef.current;
    const textareaStyles = calculateTextareaStyles();
    if (!textarea || !textareaStyles || isEmpty(textareaStyles)) {
      return;
  ...
  const frameRef = React22.useRef(-1);
  useEnhancedEffect_default(() => {
  ...
  return (0, import_jsx_runtime11.jsxs)(React22.Fragment, {
...
function useFormControl() {
  return React24.useContext(FormControlContext_default);
}
...
var InputBase = React25.forwardRef(function InputBase2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiInputBase"
  });
...
var Fade = React26.forwardRef(function Fade2(props, ref) {
  ...
  return (0, import_jsx_runtime13.jsx)(TransitionComponent, {
    ...
    children: (state, {
      ...
      return React26.cloneElement(children2, {
        style: {
          opacity: 0,
...
var Backdrop = React27.forwardRef(function Backdrop2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiBackdrop"
  });
...
true ? Backdrop.propTypes = {
  ...
  slotProps: import_prop_types23.default.shape({
    ...
    transition: import_prop_types23.default.oneOfType([import_prop_types23.default.func, import_prop_types23.default.object])
  }),
  /**
   * The components used for each slot inside.
   * @default {}
  ...
  slots: import_prop_types23.default.shape({
    root: import_prop_types23.default.elementType,
    transition: import_prop_types23.default.elementType
  }),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
true ? Button.propTypes = {
   ...
   * @default 'center'
   */
  loadingPosition: import_prop_types24.default.oneOf(["center", "end", "start"]),
  /**
   * The size of the component.
   * `small` is equivalent to the dense button styling.
   * @default 'medium'
...
function FocusTrap(props) {
  ...
  const ignoreNextEnforceFocus = React31.useRef(false);
  ...
  return (0, import_jsx_runtime16.jsxs)(React31.Fragment, {
...
true ? FocusTrap.propTypes = {
   ...
   * @default false
   */
  disableAutoFocus: import_prop_types25.default.bool,
  /**
   ...
   * @default false
   */
  disableEnforceFocus: import_prop_types25.default.bool,
  /**
   * If `true`, the focus trap will not restore focus to previously focused element once
   * focus trap is hidden or unmounted.
   * @default false
   */
  disableRestoreFocus: import_prop_types25.default.bool,
  /**
   * Returns an array of ordered tabbable nodes (i.e. in tab order) within the root.
   * For instance, you can provide the "tabbable" npm dependency.
   * @param {HTMLElement} root
   */
  getTabbable: import_prop_types25.default.func,
  /**
   ...
   * }
   */
  isEnabled: import_prop_types25.default.func,
  /**
...
true ? Modal.propTypes = {
   ...
   */
  onTransitionEnter: import_prop_types26.default.func,
  /**
   * A function called when a transition has exited.
   */
  onTransitionExited: import_prop_types26.default.func,
  /**
   * If `true`, the component is shown.
   */
...
var DialogContext = React34.createContext({});
if (true) {
...
var Dialog = React35.forwardRef(function Dialog2(inProps, ref) {
  ...
  return (0, import_jsx_runtime18.jsx)(RootSlot, {
    ...
    children: (0, import_jsx_runtime18.jsx)(TransitionSlot, {
      ...transitionSlotProps,
      children: (0, import_jsx_runtime18.jsx)(ContainerSlot, {
        onMouseDown: handleMouseDown,
        ...containerSlotProps,
        children: (0, import_jsx_runtime18.jsx)(PaperSlot, {
          ...
          ...paperSlotProps,
          children: (0, import_jsx_runtime18.jsx)(DialogContext_default.Provider, {
...
true ? Dialog.propTypes = {
   ...
   * @default true
   */
  "aria-modal": import_prop_types27.default.oneOfType([import_prop_types27.default.oneOf(["false", "true"]), import_prop_types27.default.bool]),
  /**
   * A backdrop component. This prop enables custom backdrop rendering.
   * @deprecated Use `slots.backdrop` instead. While this prop currently works, it will be removed in the next major version.
   * Use the `slots.backdrop` prop to make your application ready for the next version of Material UI.
  ...
  slotProps: import_prop_types27.default.shape({
    ...
    container: import_prop_types27.default.oneOfType([import_prop_types27.default.func, import_prop_types27.default.object]),
  ...
  slots: import_prop_types27.default.shape({
    ...
    container: import_prop_types27.default.elementType,
...
var DialogActions = React36.forwardRef(function DialogActions2(inProps, ref) {
  ...
  return (0, import_jsx_runtime19.jsx)(DialogActionsRoot, {
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    ...other
...
var DialogContent = React37.forwardRef(function DialogContent2(inProps, ref) {
  ...
  return (0, import_jsx_runtime20.jsx)(DialogContentRoot, {
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    ...other
...
var Divider = React38.forwardRef(function Divider2(inProps, ref) {
  ...
  return (0, import_jsx_runtime21.jsx)(DividerRoot, {
    as: component,
    className: clsx_default(classes.root, className),
    role,
    ref,
    ...
    ...other,
    children: children2 ? (0, import_jsx_runtime21.jsx)(DividerWrapper, {
...
var FormControl = React40.forwardRef(function FormControl2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiFormControl"
  });
  ...
  const [adornedStart, setAdornedStart] = React40.useState(() => {
    let initialAdornedStart = false;
    if (children2) {
      React40.Children.forEach(children2, (child) => {
  ...
  const [filled, setFilled] = React40.useState(() => {
  ...
  const onFilled = React40.useCallback(() => {
    setFilled(true);
  }, []);
  const onEmpty = React40.useCallback(() => {
    setFilled(false);
  }, []);
...
var FormHelperText = React41.forwardRef(function FormHelperText2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiFormHelperText"
  });
...
var Grow = React43.forwardRef(function Grow2(props, ref) {
  const {
    addEndListener,
    appear = true,
    children: children2,
  ...
  return (0, import_jsx_runtime26.jsx)(TransitionComponent, {
    ...
    children: (state, {
      ...
      return React43.cloneElement(children2, {
        style: {
          opacity: 0,
...
var Input = React44.forwardRef(function Input2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiInput"
  });
...
var InputAdornment = React45.forwardRef(function InputAdornment2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiInputAdornment"
  });
  ...
  return (0, import_jsx_runtime28.jsx)(FormControlContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime28.jsx)(InputAdornmentRoot, {
      ...
      children: typeof children2 === "string" && !disableTypography ? (0, import_jsx_runtime28.jsx)(Typography_default, {
        color: "textSecondary",
        children: children2
      }) : (0, import_jsx_runtime28.jsxs)(React45.Fragment, {
...
var InputLabel = React46.forwardRef(function InputLabel2(inProps, ref) {
  const props = useDefaultProps({
    name: "MuiInputLabel",
    props: inProps
  });
...
var List = React48.forwardRef(function List2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiList"
  });
...
var ListItem = React51.forwardRef(function ListItem2(inProps, ref) {
  ...
  const children2 = React51.Children.toArray(childrenProp);
  ...
  return (0, import_jsx_runtime33.jsx)(ListContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime33.jsxs)(Root, {
      ...
      ...componentProps,
      children: [children2, secondaryAction && (0, import_jsx_runtime33.jsx)(SecondaryActionSlot, {
...
true ? ListItem.propTypes = {
  ...
  children: chainPropTypes(import_prop_types42.default.node, (props) => {
    const children2 = React51.Children.toArray(props.children);
   ...
   */
  ContainerProps: import_prop_types42.default.object,
  /**
   * If `true`, compact vertical padding designed for keyboard and mouse input is used.
   * The prop defaults to the value inherited from the parent List component.
   * @default false
   ...
   * @default false
   */
  disablePadding: import_prop_types42.default.bool,
  /**
   * If `true`, a 1px light border is added to the bottom of the list item.
   * @default false
   */
   ...
   */
  secondaryAction: import_prop_types42.default.node,
  /**
   * The extra props for the slot components.
   * You can override the existing props or add new ones.
   *
  ...
  slotProps: import_prop_types42.default.shape({
    root: import_prop_types42.default.object,
    secondaryAction: import_prop_types42.default.oneOfType([import_prop_types42.default.func, import_prop_types42.default.object])
  }),
  /**
   * The components used for each slot inside.
   *
  ...
  slots: import_prop_types42.default.shape({
    root: import_prop_types42.default.elementType,
    secondaryAction: import_prop_types42.default.elementType
  }),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var ListItemIcon = React52.forwardRef(function ListItemIcon2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiListItemIcon"
  });
  ...
  return (0, import_jsx_runtime34.jsx)(ListItemIconRoot, {
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    ...other
...
var ListItemTextRoot = styled_default("div", {
  ...
  marginTop: 4,
  marginBottom: 4,
  [`.${typographyClasses_default.root}:where(& .${listItemTextClasses_default.primary}), .${typographyClasses_default.root}:where(& .${listItemTextClasses_default.secondary})`]: {
    display: "block"
  },
  variants: [{
    props: ({
...
var ListItemText = React53.forwardRef(function ListItemText2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiListItemText"
  });
  ...
  const {
    dense
  } = React53.useContext(ListContext_default);
  ...
  if (primary != null && primary.type !== Typography_default && !disableTypography) {
    primary = (0, import_jsx_runtime35.jsx)(PrimarySlot, {
  ...
  if (secondary != null && secondary.type !== Typography_default && !disableTypography) {
    secondary = (0, import_jsx_runtime35.jsx)(SecondarySlot, {
      variant: "body2",
      color: "textSecondary",
      ...secondarySlotProps,
      children: secondary
  ...
  return (0, import_jsx_runtime35.jsxs)(RootSlot, {
    ...rootSlotProps,
...
true ? ListItemText.propTypes = {
   ...
   * @default false
   */
  inset: import_prop_types44.default.bool,
  /**
   * The main content element.
   */
  primary: import_prop_types44.default.node,
  /**
   * These props will be forwarded to the primary typography component
   * (as long as disableTypography is not `true`).
   * @deprecated Use `slotProps.primary` instead. This prop will be removed in a future major release. See [Migrating from deprecated APIs](/material-ui/migration/migrating-from-deprecated-apis/) for more details.
   */
  primaryTypographyProps: import_prop_types44.default.object,
  /**
   * The secondary content element.
   */
  secondary: import_prop_types44.default.node,
  /**
   * These props will be forwarded to the secondary typography component
   * (as long as disableTypography is not `true`).
   * @deprecated Use `slotProps.secondary` instead. This prop will be removed in a future major release. See [Migrating from deprecated APIs](/material-ui/migration/migrating-from-deprecated-apis/) for more details.
   */
  secondaryTypographyProps: import_prop_types44.default.object,
  /**
   * The props used for each slot inside.
   * @default {}
   */
  slotProps: import_prop_types44.default.shape({
    primary: import_prop_types44.default.oneOfType([import_prop_types44.default.func, import_prop_types44.default.object]),
    root: import_prop_types44.default.oneOfType([import_prop_types44.default.func, import_prop_types44.default.object]),
    secondary: import_prop_types44.default.oneOfType([import_prop_types44.default.func, import_prop_types44.default.object])
  }),
  /**
   * The components used for each slot inside.
   * @default {}
  ...
  slots: import_prop_types44.default.shape({
    primary: import_prop_types44.default.elementType,
    root: import_prop_types44.default.elementType,
    secondary: import_prop_types44.default.elementType
  }),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var MenuList = React54.forwardRef(function MenuList2(props, ref) {
  const {
    // private
    // eslint-disable-next-line react/prop-types
    actions,
  ...
  React54.Children.forEach(children2, (child, index) => {
  ...
  const items = React54.Children.map(children2, (child, index) => {
    if (index === activeItemIndex) {
      ...
      return React54.cloneElement(child, newChildProps);
    }
    return child;
  });
  return (0, import_jsx_runtime36.jsx)(List_default, {
    role: "menu",
    ref: handleRef,
    className,
    onKeyDown: handleKeyDown,
...
var Popover = React55.forwardRef(function Popover2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiPopover"
  });
  ...
  const getAnchorOffset = React55.useCallback(() => {
  ...
  const getTransformOrigin = React55.useCallback((elemRect) => {
    return {
      vertical: getOffsetTop(elemRect, transformOrigin.vertical),
      horizontal: getOffsetLeft(elemRect, transformOrigin.horizontal)
    };
  }, [transformOrigin.horizontal, transformOrigin.vertical]);
  const getPositioningStyle = React55.useCallback((element) => {
    const elemRect = {
  ...
  const [isPositioned, setIsPositioned] = React55.useState(open);
  const setPositioningStyles = React55.useCallback(() => {
  ...
  React55.useImperativeHandle(action, () => open ? {
    updatePosition: () => {
      setPositioningStyles();
    }
  ...
  return (0, import_jsx_runtime37.jsx)(RootSlot, {
    ...
    children: (0, import_jsx_runtime37.jsx)(TransitionSlot, {
      ...transitionSlotProps,
      timeout: transitionDuration,
      children: (0, import_jsx_runtime37.jsx)(PaperSlot, {
        ...paperProps,
        children: children2
      })
    })
...
var Menu = React56.forwardRef(function Menu2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiMenu"
  });
  ...
  const menuListActionsRef = React56.useRef(null);
  ...
  let activeItemIndex = -1;
  React56.Children.map(children2, (child, index) => {
  ...
  return (0, import_jsx_runtime38.jsx)(MenuRoot, {
    onClose,
    anchorOrigin: {
      vertical: "bottom",
    ...
    children: (0, import_jsx_runtime38.jsx)(ListSlot, {
...
var MenuItem = React57.forwardRef(function MenuItem2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiMenuItem"
  });
  ...
  const menuItemRef = React57.useRef(null);
  useEnhancedEffect_default2(() => {
    if (autoFocus) {
  ...
  return (0, import_jsx_runtime39.jsx)(ListContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime39.jsx)(MenuItemRoot, {
      ref: handleRef,
      role,
      tabIndex,
      component,
...
function NotchedOutline(props) {
  ...
  return (0, import_jsx_runtime40.jsx)(NotchedOutlineRoot, {
    "aria-hidden": true,
    className,
    ownerState,
    ...other,
    children: (0, import_jsx_runtime40.jsx)(NotchedOutlineLegend, {
      ownerState,
      children: withLabel ? (0, import_jsx_runtime40.jsx)("span", {
        children: label
      }) : (
        // notranslate needed while Google Translate will not fix zero-width space issue
        _span3 || (_span3 = (0, import_jsx_runtime40.jsx)("span", {
          className: "notranslate",
          "aria-hidden": true,
          children: "​"
        }))
...
var OutlinedInput = React58.forwardRef(function OutlinedInput2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiOutlinedInput"
  });
  ...
  const [NotchedSlot, notchedProps] = useSlot("notchedOutline", {
    ...
    additionalProps: {
      label: label != null && label !== "" && fcs.required ? (0, import_jsx_runtime41.jsxs)(React58.Fragment, {
        children: [label, " ", "*"]
      }) : label
    }
  });
  return (0, import_jsx_runtime41.jsx)(InputBase_default, {
    ...
    slotProps,
    renderSuffix: (state) => (0, import_jsx_runtime41.jsx)(NotchedSlot, {
      ...notchedProps,
...
true ? OutlinedInput.propTypes = {
  ...
  slotProps: import_prop_types50.default.shape({
    ...
    notchedOutline: import_prop_types50.default.oneOfType([import_prop_types50.default.func, import_prop_types50.default.object]),
  ...
  slots: import_prop_types50.default.shape({
    input: import_prop_types50.default.elementType,
    notchedOutline: import_prop_types50.default.elementType,
    root: import_prop_types50.default.elementType
  }),
  /**
   * Start `InputAdornment` for this component.
...
var NativeSelectInput = React59.forwardRef(function NativeSelectInput2(props, ref) {
  const {
    className,
    disabled,
    error,
  ...
  return (0, import_jsx_runtime42.jsxs)(React59.Fragment, {
    children: [(0, import_jsx_runtime42.jsx)(NativeSelectSelect, {
      ownerState,
      className: clsx_default(classes.select, className),
      disabled,
      ref: inputRef || ref,
      ...other
    }), props.multiple ? null : (0, import_jsx_runtime42.jsx)(NativeSelectIcon, {
      as: IconComponent,
      ownerState,
...
var SelectInput = React60.forwardRef(function SelectInput2(props, ref) {
  var _a, _b, _c, _d;
  const {
    "aria-describedby": ariaDescribedby,
  ...
  const displayRef = React60.useRef(null);
  const [displayNode, setDisplayNode] = React60.useState(null);
  const {
    current: isOpenControlled
  } = React60.useRef(openProp != null);
  const [menuMinWidthState, setMenuMinWidthState] = React60.useState();
  const handleRef = useForkRef_default(ref, inputRefProp);
  const handleDisplayRef = React60.useCallback((node) => {
  ...
  React60.useImperativeHandle(handleRef, () => ({
    focus: () => {
  ...
  const childrenArray = React60.Children.toArray(children2);
  const handleChange = (event) => {
  ...
  return (0, import_jsx_runtime43.jsxs)(React60.Fragment, {
    children: [(0, import_jsx_runtime43.jsx)(SelectSelect, {
      as: "div",
    ...
    }), (0, import_jsx_runtime43.jsx)(SelectNativeInput, {
      "aria-invalid": error,
      ...
      ...other,
      ownerState
    }), (0, import_jsx_runtime43.jsx)(SelectIcon, {
      as: IconComponent,
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime43.jsx)(Menu_default, {
      id: `menu-${name || ""}`,
...
var ArrowDropDown_default = createSvgIcon((0, import_jsx_runtime44.jsx)("path", {
  d: "M7 10l5 5 5-5z"
}), "ArrowDropDown");
...
var Select = React61.forwardRef(function Select2(inProps, ref) {
  const props = useDefaultProps({
    name: "MuiSelect",
    props: inProps
  });
  ...
  const InputComponent = input || {
    standard: (0, import_jsx_runtime45.jsx)(StyledInput, {
      ownerState
    }),
    outlined: (0, import_jsx_runtime45.jsx)(StyledOutlinedInput, {
      label,
      ownerState
    }),
    filled: (0, import_jsx_runtime45.jsx)(StyledFilledInput, {
      ownerState
    })
  }[variant];
  ...
  return (0, import_jsx_runtime45.jsx)(React61.Fragment, {
    children: React61.cloneElement(InputComponent, {
...
true ? Select.propTypes = {
   ...
   */
  value: import_prop_types53.default.oneOfType([import_prop_types53.default.oneOf([""]), import_prop_types53.default.any]),
  /**
   * The variant to use.
   * @default 'outlined'
   */
...
var Tab = React62.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime46.jsxs)(TabRoot, {
    focusRipple: !disableFocusRipple,
    className: clsx_default(classes.root, className),
    ref,
    role: "tab",
    ...
    ...other,
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime46.jsxs)(React62.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime46.jsxs)(React62.Fragment, {
      children: [label, icon]
    }), indicator]
  });
});
true ? Tab.propTypes = {
   ...
   * The icon to display.
   */
  icon: import_prop_types54.default.oneOfType([import_prop_types54.default.element, import_prop_types54.default.string]),
  /**
   * The position of the icon relative to the label.
   * @default 'top'
   */
  iconPosition: import_prop_types54.default.oneOf(["bottom", "end", "start", "top"]),
  /**
   * The label element.
   */
   ...
   * @default false
   */
  wrapped: import_prop_types54.default.bool
} : void 0;
var Tab_default = Tab;
...
var KeyboardArrowLeft_default = createSvgIcon((0, import_jsx_runtime47.jsx)("path", {
  d: "M15.41 16.09l-4.58-4.59 4.58-4.59L14 5.5l-6 6 6 6z"
}), "KeyboardArrowLeft");

// node_modules/@mui/material/esm/internal/svg-icons/KeyboardArrowRight.js
var import_jsx_runtime48 = __toESM(require_jsx_runtime(), 1);
var KeyboardArrowRight_default = createSvgIcon((0, import_jsx_runtime48.jsx)("path", {
...
var TabScrollButton = React63.forwardRef(function TabScrollButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime49.jsx)(TabScrollButtonRoot, {
    component: "div",
    className: clsx_default(classes.root, className),
    ref,
    role: null,
    ...
    children: direction === "left" ? (0, import_jsx_runtime49.jsx)(StartButtonIcon, {
      ...startButtonIconProps
    }) : (0, import_jsx_runtime49.jsx)(EndButtonIcon, {
      ...endButtonIconProps
    })
  });
});
true ? TabScrollButton.propTypes = {
   ...
   */
  direction: import_prop_types55.default.oneOf(["left", "right"]).isRequired,
  /**
   * If `true`, the component is disabled.
   * @default false
   */
   ...
   */
  orientation: import_prop_types55.default.oneOf(["horizontal", "vertical"]).isRequired,
  /**
   * The extra props for the slot components.
   * You can override the existing props or add new ones.
   * @default {}
...
var Tabs = React65.forwardRef(function Tabs2(inProps, ref) {
  ...
  const [displayStartScroll, setDisplayStartScroll] = React65.useState(false);
  const [displayEndScroll, setDisplayEndScroll] = React65.useState(false);
  const [updateScrollObserver, setUpdateScrollObserver] = React65.useState(false);
  ...
  const getTabsMeta = () => {
    ...
    if (tabsNode && value !== false) {
      ...
      if (children3.length > 0) {
        ...
        if (true) {
          if (isLayoutSupported() && !warnedOnceTabPresent && tabMeta && tabMeta.width === 0 && tabMeta.height === 0 && // if the whole Tabs component is hidden, don't warn
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollbarSizeListener = scrollable ? (0, import_jsx_runtime51.jsx)(ScrollbarSlot, {
      ...scrollbarSlotProps,
      onChange: handleScrollbarSizeChange
    }) : null;
    const scrollButtonsActive = displayStartScroll || displayEndScroll;
    const showScrollButtons = scrollable && (scrollButtons === "auto" && scrollButtonsActive || scrollButtons === true);
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime51.jsx)(ScrollButtonsSlot, {
      direction: isRtl ? "right" : "left",
      onClick: handleStartScrollClick,
      disabled: !displayStartScroll,
      ...scrollButtonSlotProps
    }) : null;
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime51.jsx)(ScrollButtonsSlot, {
  ...
  const indicator = (0, import_jsx_runtime51.jsx)(IndicatorSlot, {
    ...indicatorSlotProps
  });
  let childIndex = 0;
  ...
  return (0, import_jsx_runtime51.jsxs)(RootSlot, {
    ...rootSlotProps,
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime51.jsxs)(ScrollerSlot, {
      ...scrollerSlotProps,
      children: [(0, import_jsx_runtime51.jsx)(ListSlot, {
        "aria-label": ariaLabel,
        "aria-labelledby": ariaLabelledBy,
...
true ? Tabs.propTypes = {
   ...
   * @default false
   */
  allowScrollButtonsMobile: import_prop_types57.default.bool,
  /**
   ...
   * @default false
   */
  centered: import_prop_types57.default.bool,
  /**
   * The content of the component.
   */
   ...
   * @default 'primary'
   */
  indicatorColor: import_prop_types57.default.oneOfType([import_prop_types57.default.oneOf(["primary", "secondary"]), import_prop_types57.default.string]),
  /**
   ...
   */
  ScrollButtonComponent: import_prop_types57.default.elementType,
  /**
   ...
   * @default 'auto'
   */
  scrollButtons: import_prop_types57.default.oneOf(["auto", false, true]),
  /**
   * If `true` the selected tab changes on focus. Otherwise it only
   * changes on activation.
   */
  selectionFollowsFocus: import_prop_types57.default.bool,
  /**
   * The props used for each slot inside.
   * @default {}
   */
  slotProps: import_prop_types57.default.shape({
    endScrollButtonIcon: import_prop_types57.default.oneOfType([import_prop_types57.default.func, import_prop_types57.default.object]),
    indicator: import_prop_types57.default.oneOfType([import_prop_types57.default.func, import_prop_types57.default.object]),
    ...
    scrollbar: import_prop_types57.default.oneOfType([import_prop_types57.default.func, import_prop_types57.default.object]),
    scrollButtons: import_prop_types57.default.oneOfType([import_prop_types57.default.func, import_prop_types57.default.object]),
    scroller: import_prop_types57.default.oneOfType([import_prop_types57.default.func, import_prop_types57.default.object]),
    startScrollButtonIcon: import_prop_types57.default.oneOfType([import_prop_types57.default.func, import_prop_types57.default.object])
  }),
  /**
   * The components used for each slot inside.
   * @default {}
  ...
  slots: import_prop_types57.default.shape({
    endScrollButtonIcon: import_prop_types57.default.elementType,
    EndScrollButtonIcon: import_prop_types57.default.elementType,
    indicator: import_prop_types57.default.elementType,
    list: import_prop_types57.default.elementType,
    root: import_prop_types57.default.elementType,
    scrollbar: import_prop_types57.default.elementType,
    scrollButtons: import_prop_types57.default.elementType,
    scroller: import_prop_types57.default.elementType,
    startScrollButtonIcon: import_prop_types57.default.elementType,
    StartScrollButtonIcon: import_prop_types57.default.elementType
  }),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   ...
   * @default  {}
   */
  TabIndicatorProps: import_prop_types57.default.object,
  /**
   * Props applied to the [`TabScrollButton`](https://mui.com/material-ui/api/tab-scroll-button/) element.
   * @deprecated use the `slotProps.scrollButtons` prop instead. This prop will be removed in a future major release. See [Migrating from deprecated APIs](https://mui.com/material-ui/migration/migrating-from-deprecated-apis/) for more details.
   * @default {}
   */
  TabScrollButtonProps: import_prop_types57.default.object,
  /**
   * Determines the color of the `Tab`.
   * @default 'primary'
   */
  textColor: import_prop_types57.default.oneOf(["inherit", "primary", "secondary"]),
  /**
   ...
   * @default 'standard'
   */
  variant: import_prop_types57.default.oneOf(["fullWidth", "scrollable", "standard"]),
  /**
   * If `true`, the scrollbar is visible. It can be useful when displaying
   * a long vertical list of tabs.
   * @default false
   */
  visibleScrollbar: import_prop_types57.default.bool
} : void 0;
...
var TextField = React66.forwardRef(function TextField2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTextField"
  });
  ...
  const InputElement = (0, import_jsx_runtime52.jsx)(InputSlot, {
  ...
  return (0, import_jsx_runtime52.jsxs)(RootSlot, {
    ...rootProps,
    children: [label != null && label !== "" && (0, import_jsx_runtime52.jsx)(InputLabelSlot, {
      htmlFor: id,
      id: inputLabelId,
      ...inputLabelProps,
      children: label
    }), select ? (0, import_jsx_runtime52.jsx)(SelectSlot, {
      "aria-describedby": helperTextId,
      id,
      ...
      ...selectProps,
      children: children2
    }) : InputElement, helperText && (0, import_jsx_runtime52.jsx)(FormHelperTextSlot, {
      id: helperTextId,
      ...formHelperTextProps,
      children: helperText
    })]
...
true ? TextField.propTypes = {
   ...
   */
  FormHelperTextProps: import_prop_types58.default.object,
  /**
   * If `true`, the input will take up the full width of its container.
   * @default false
   */
   ...
   */
  helperText: import_prop_types58.default.node,
  /**
   * The id of the `input` element.
   ...
   */
  InputLabelProps: import_prop_types58.default.object,
  /**
   * [Attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/input#attributes) applied to the `input` element.
   ...
   * @default false
   */
  select: import_prop_types58.default.bool,
  /**
  ...
  slotProps: import_prop_types58.default.shape({
    formHelperText: import_prop_types58.default.oneOfType([import_prop_types58.default.func, import_prop_types58.default.object]),
    htmlInput: import_prop_types58.default.oneOfType([import_prop_types58.default.func, import_prop_types58.default.object]),
    input: import_prop_types58.default.oneOfType([import_prop_types58.default.func, import_prop_types58.default.object]),
    inputLabel: import_prop_types58.default.oneOfType([import_prop_types58.default.func, import_prop_types58.default.object]),
    select: import_prop_types58.default.oneOfType([import_prop_types58.default.func, import_prop_types58.default.object])
  }),
  /**
   * The components used for each slot inside.
   * @default {}
  ...
  slots: import_prop_types58.default.shape({
    formHelperText: import_prop_types58.default.elementType,
    htmlInput: import_prop_types58.default.elementType,
    input: import_prop_types58.default.elementType,
    inputLabel: import_prop_types58.default.elementType,
    root: import_prop_types58.default.elementType,
    select: import_prop_types58.default.elementType
  }),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
//# sourceMappingURL=chunk-AG3FOLPK.js.map
