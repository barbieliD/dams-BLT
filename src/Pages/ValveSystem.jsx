...
const leftMetricsConfig = [
  { title: "USV-1", openTag: "2001", closeTag: "2002" },
  { title: "LSV-1", openTag: "2003", closeTag: "2004" },
  { title: "RV-1", openTag: "2005", closeTag: "2006" },
  { title: "PEV-1", openTag: "2007", closeTag: "2008" },
  { title: "SEV-1", openTag: "2009", closeTag: "2010" },
];
            ...
            {leftSideMetrics.map((m) => (
              <Box key={m.tagId} sx={{ flex: 1 }}>
                ...
                <Box sx={{ display: "flex", gap: 0.5 }}>
                    <Value value={latestByTag[m.openTag] ?? "NA"} unit="sec" />
                    <Value value={latestByTag[m.closeTag] ?? "NA"} unit="sec" />
                </Box>
              </Box>
            ))}
        </Box>
